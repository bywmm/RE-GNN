...
# GraphSAGE
python run_regnn.py --dataset DBLP --model resage --save_postfix DBLP-resage --repeat 10 --dropout 0.5 --R 10 --device $1

# GIN
python run_regnn.py --dataset DBLP --model regin --save_postfix DBLP_regin --repeat 10 --device $1